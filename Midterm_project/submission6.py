...
df_train.drop(['Name','Ticket','Cabin','Pclass','PassengerId','SibSp'], axis=1, inplace=True)
...
#Test part
#Remove not using columns
df_test.drop(['Name','Ticket','Cabin','Pclass','PassengerId','SibSp'], axis=1, inplace=True)
...
#Output
SubmissionDF.to_csv('submission6.csv', index=False)
