...
df_train.drop(['Name','Ticket','Cabin','Pclass'], axis=1, inplace=True)
...
#Test part
#Remove not using columns
df_test.drop(['Name','Ticket','Cabin','Pclass'], axis=1, inplace=True)
...
#Output
SubmissionDF.to_csv('submission3.csv', index=False)
